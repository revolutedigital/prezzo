      ...
      <header className="border-b bg-white/80 backdrop-blur-sm fixed w-full top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-8">
            <a href="#funcionalidades" className="text-gray-600 hover:text-emerald-600 transition">Funcionalidades</a>
            <a href="#beneficios" className="text-gray-600 hover:text-emerald-600 transition">Benefícios</a>
            <a href="#industrias" className="text-gray-600 hover:text-emerald-600 transition">Indústrias</a>
          </nav>
          <Link
            href="/login"
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              ...
              <span className="text-emerald-500"> Precisão Absoluta</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/login"
                className="bg-emerald-500 text-white px-8 py-4 rounded-lg hover:bg-emerald-600 transition font-semibold text-lg flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/30"
              >
                Começar Agora
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-emerald-100">Precisão nos Cálculos</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">60%</div>
              <div className="text-emerald-100">Redução de Tempo</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">100%</div>
              <div className="text-emerald-100">Controle de Custos</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">24/7</div>
              <div className="text-emerald-100">Disponibilidade</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="funcionalidades" className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl border-2 border-gray-100 hover:border-emerald-500 transition hover:shadow-lg">
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={industry} className="bg-white p-6 rounded-lg border border-gray-200 hover:border-emerald-500 transition">
      ...
      <section id="beneficios" className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 p-12 rounded-2xl text-white">
              ...
              <Link
                href="/login"
                className="inline-flex items-center gap-2 bg-white text-emerald-600 px-8 py-4 rounded-lg hover:bg-emerald-50 transition font-semibold text-lg"
              >
                Acessar o Sistema
                <ArrowRight className="w-5 h-5" />
              </Link>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#funcionalidades" className="hover:text-emerald-500 transition">Funcionalidades</a></li>
                <li><a href="#industrias" className="hover:text-emerald-500 transition">Indústrias</a></li>
                <li><a href="#beneficios" className="hover:text-emerald-500 transition">Benefícios</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-white font-semibold mb-4">Empresa</h4>
              <ul className="space-y-2 text-sm">
                <li><a href="#" className="hover:text-emerald-500 transition">Sobre</a></li>
                <li><a href="#" className="hover:text-emerald-500 transition">Contato</a></li>
                <li><a href="#" className="hover:text-emerald-500 transition">Suporte</a></li>
              </ul>
            </div>
            <div>
              ...
              <Link
                href="/login"
                className="inline-block bg-emerald-500 text-white px-6 py-2 rounded-lg hover:bg-emerald-600 transition text-sm font-medium"
              >
                Entrar no Sistema
              </Link>
            </div>
