    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="pt-32 pb-20 px-6">
        <div className="container mx-auto max-w-4xl">
          <div className="mb-16">
            <div className="font-mono text-xs uppercase tracking-widest text-blue-500 mb-4">Legal</div>
            <h1 className="text-6xl md:text-7xl font-black tracking-tighter mb-6">TERMOS DE<br />USO</h1>
          ...
          <div className="space-y-8 font-mono leading-relaxed text-gray-300">
            <section>
              <h2 className="text-2xl font-black text-white mb-4 uppercase">1. Aceitação dos Termos</h2>
            ...
            <section>
              ...
              <p>O Prezzo é um sistema de gestão de custos e precificação. Você é responsável pela precisão dos dados inseridos e pelas decisões tomadas baseadas neles.</p>
            </section>

            <section>
              <h2 className="text-2xl font-black text-white mb-4 uppercase">3. Conta de Usuário</h2>
              <p>Você é responsável por manter a segurança da sua conta e senha. Não compartilhe suas credenciais.</p>
            </section>

            <section>
              <h2 className="text-2xl font-black text-white mb-4 uppercase">4. Propriedade dos Dados</h2>
              <p>Você mantém total propriedade sobre seus dados. Nós apenas armazenamos e processamos conforme necessário para prover o serviço.</p>
            </section>
            ...
            <section>
              ...
              <p>Você pode cancelar sua conta a qualquer momento. Seus dados serão excluídos conforme nossa política de privacidade.</p>
            </section>

            <section>
              <h2 className="text-2xl font-black text-white mb-4 uppercase">7. Modificações</h2>
              <p>Reservamo-nos o direito de modificar estes termos. Mudanças significativas serão comunicadas por email.</p>
            </section>
          </div>

          <div className="mt-16 p-8 border border-white/10">
            <p className="font-mono text-gray-400 text-sm">
              Dúvidas sobre os termos? Entre em contato: <span className="text-blue-500">contato@prezzo.com.br</span>
            </p>
          </div>
        </div>
      </main>
