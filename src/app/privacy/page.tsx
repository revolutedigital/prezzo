      ...
      <main className="pt-32 pb-20 px-6">
        <div className="container mx-auto max-w-4xl">
          <div className="mb-16">
            ...
            <h1 className="text-6xl md:text-7xl font-black tracking-tighter mb-6">POLÍTICA DE<br />PRIVACIDADE</h1>
          ...
          <div className="space-y-8 font-mono leading-relaxed text-gray-300">
            <section>
              ...
              <p>Coletamos apenas os dados necessários para operar o sistema: nome, email, informações de empresa e dados de custos/produtos inseridos por você.</p>
            </section>

            <section>
              <h2 className="text-2xl font-black text-white mb-4 uppercase">2. Uso dos Dados</h2>
              <p>Seus dados são usados exclusivamente para prover os serviços do Prezzo. Não vendemos, compartilhamos ou utilizamos seus dados para outros fins.</p>
            </section>

            <section>
              <h2 className="text-2xl font-black text-white mb-4 uppercase">3. Segurança</h2>
              <p>Utilizamos criptografia e medidas de segurança padrão da indústria para proteger seus dados.</p>
            </section>

            <section>
              <h2 className="text-2xl font-black text-white mb-4 uppercase">4. Seus Direitos</h2>
              <p>Você pode solicitar acesso, correção ou exclusão dos seus dados a qualquer momento através do contato@prezzo.com.br</p>
            </section>

            <section>
              <h2 className="text-2xl font-black text-white mb-4 uppercase">5. Cookies</h2>
              <p>Utilizamos apenas cookies essenciais para autenticação e funcionamento do sistema.</p>
            </section>
          ...
          <div className="mt-16 p-8 border border-white/10">
            <p className="font-mono text-gray-400 text-sm">
              Para dúvidas sobre privacidade, entre em contato: <span className="text-blue-500">contato@prezzo.com.br</span>
            </p>
          </div>
        </div>
      </main>
